...
// });
    return ( 
        <section className="hero__slider--section">
            <Swiper className="hero__slider--activation"
                slidesPerView={1}
                loop
                ...
                <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                        <div className="home__three--slider__items">
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-8 col-md-7 offset-lg-2">
                                        <div className="slider__content text-center">
                                            <h2 className="slider__maintitle text__primary h1">Jewelry to fit every budget, occasion, and taste</h2>
                            ...
                            <div className="hero__slider--layer style3">
                                <img className="slider__layer--img" src="assets/img/slider/home3-slider1-layer.webp" alt="slider-img"/>
                            </div>  
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                        <div className="home__three--slider__items">
                            ...
                            <div className="hero__slider--layer style3">
                                <img className="slider__layer--img" src="assets/img/slider/home3-slider2-layer.webp" alt="slider-img"/>
                            </div>  
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                        <div className="home__three--slider__items">
                            ...
                            <div className="hero__slider--layer style3">
                                <img className="slider__layer--img" src="assets/img/slider/home3-slider3-layer.webp" alt="slider-img"/>
                            </div>  
                        </div>
                    </SwiperSlide>
                </div>
...
export default CanvasHeaderMenu;